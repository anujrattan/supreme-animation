...
const industries: Industry[] = [
  ...
  {
    id: "video-games",
    name: "Video Game Trailer Production",
    icon: Gamepad2,
    color: "#8B5CF6",
    iconColor: "#7C3AED",
  },
  {
    id: "insurance",
    name: "Insurance Animation and Explainer Videos",
    icon: Shield,
    color: "#6366F1",
    iconColor: "#4F46E5",
  },
  ...
  {
    id: "ecommerce",
    name: "Ecommerce Video Production",
    icon: ShoppingCart,
    color: "#14B8A6",
    iconColor: "#0D9488",
  },
  {
    id: "finance",
    name: "Finance & FinTech Animation",
    icon: DollarSign,
    color: "#F97316",
    iconColor: "#EA580C",
  },
